...
{   RGBTRIPLE copy[height][width];
    ...
    for (int latitude=0;latitude<height;latitude++)
    {
        for (int longitude=0;longitude<width;longitude++)
        {
            ...
            {
                image[latitude][longitude] = avg4(copy[latitude][longitude],copy[latitude][longitude+1] , copy[latitude+1][longitude] , copy[latitude+1][longitude+1] );
            }
            ...
            {
                image[latitude][longitude] = avg4(copy[latitude][longitude],copy[latitude-1][longitude],copy[latitude][longitude+1],copy[latitude-1][longitude+1]);
            }
            ...
            {
                image[latitude][longitude] = avg6(copy[latitude][longitude],copy[latitude][longitude-1],copy[latitude][longitude+1],copy[latitude+1][longitude-1],copy[latitude+1][longitude],copy[latitude+1][longitude+1]);
            }

            else if (longitude == 0) //left edge
            {
                image[latitude][longitude] = avg6(copy[latitude][longitude],copy[latitude-1][longitude],copy[latitude+1][longitude],copy[latitude][longitude+1],copy[latitude-1][longitude+1],copy[latitude+1][longitude+1]);
            }
            ...
            {
                image[latitude][longitude] = avg6(copy[latitude][longitude],copy[latitude][longitude-1],copy[latitude][longitude+1],copy[latitude-1][longitude],copy[latitude-1][longitude-1],copy[latitude-1][longitude+1]);
            }
            else
            {
                image[latitude][longitude]= avg9(copy[latitude-1][longitude-1],copy[latitude-1][longitude],copy[latitude-1][longitude+1],copy[latitude][longitude-1],copy[latitude][longitude],copy[latitude][longitude+1],copy[latitude+1][longitude-1],copy[latitude+1][longitude],copy[latitude+1][longitude+1]);
            }
...
{
    RGBTRIPLE temp;
    temp.rgbtRed = round((one.rgbtRed+two.rgbtRed+three.rgbtRed+four.rgbtRed+five.rgbtRed+six.rgbtRed+seven.rgbtRed+eight.rgbtRed+nine.rgbtRed)/9.0);
    temp.rgbtBlue = round((one.rgbtBlue+two.rgbtBlue+three.rgbtBlue+four.rgbtBlue+five.rgbtBlue+six.rgbtBlue+seven.rgbtBlue+eight.rgbtBlue+nine.rgbtBlue)/9.0);
    temp.rgbtGreen = round((one.rgbtGreen+two.rgbtGreen+three.rgbtGreen+four.rgbtGreen+five.rgbtGreen+six.rgbtGreen+seven.rgbtGreen+eight.rgbtGreen+nine.rgbtGreen)/9.0);
